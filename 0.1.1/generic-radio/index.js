import { S as SelectedMixin, B as BatchingElement } from '../SelectedMixin-ae217ba9.js';
...
`;
class GenericRadio extends SelectedMixin(BatchingElement) {
  static get config() {
    return {
      selectors: {
        radios: {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.querySelector('.group').setAttribute('aria-label', this.getAttribute('label') || 'radiogroup');
  }
